		...
		<div className="container">
			<div className = 'task'>
				<div className = "header">
					...
					<h3 className="userName"><Link className="tLink" to="/account">{post.userName}</Link></h3>
					<h3 className="courseName"><Link className="tLink" to="/joinclass">{post.courseName}</Link></h3>
