...
router.post('/like/:id', verify, detailedPostFunctions.likePost)
...
router.post('/editaccount', verify, accountFunctions.updateAccount)
router.post('/deletePost', verify, accountFunctions.deletePost)
